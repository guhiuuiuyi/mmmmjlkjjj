...
UUID=${UUID:-'055c63cd-eb35-4cd6-a632-aa576bdbf9a1'}
VMESS_WSPATH=${VMESS_WSPATH:-'/055c63cd-eb35-4cd6-a632-aa576bdbf9a1-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/055c63cd-eb35-4cd6-a632-aa576bdbf9a1-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/055c63cd-eb35-4cd6-a632-aa576bdbf9a1-trojan'}
SS_WSPATH=${SS_WSPATH:-'/055c63cd-eb35-4cd6-a632-aa576bdbf9a1-shadowsocks'}
